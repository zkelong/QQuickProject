...
View {
    ...
    ListModel {
        id: appModel
        ListElement {name: "Musice-1"; icon: "qrc:/res/1.jpg"}
        ListElement {name: "Movie-2"; icon: "qrc:/res/2.jpg"}
        ListElement {name: "Camera-3"; icon: "qrc:/res/3.jpg"}
        ListElement {name: "Messaging-4"; icon: "qrc:/res/5.jpg"}
        ListElement {name: "ContactsList-5"; icon: "qrc:/res/6.jpg"}
    }
