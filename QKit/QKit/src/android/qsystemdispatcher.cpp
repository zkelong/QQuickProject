...
#include <QPointer>
#include <QtCore>
#include "qsystemdispatcher.h"

static QPointer<QSystemDispatcher> m_instance;

#ifdef Q_OS_ANDROID
#include <QAndroidJniObject>
#include <QAndroidJniEnvironment>

#define JCLASS_Name "qkit/SystemDispatcher"
...
QSystemDispatcher::QSystemDispatcher(QObject* parent) : QObject(parent)
{

}

QSystemDispatcher::~QSystemDispatcher()
{

}

QSystemDispatcher *QSystemDispatcher::instance()
{
    if (!m_instance) {
        QCoreApplication* app = QCoreApplication::instance();
        m_instance = new QSystemDispatcher(app);
    }
    return m_instance;
}

void QSystemDispatcher::dispatch(QString name, QVariantMap message)
{
#ifdef Q_OS_ANDROID
    QAndroidJniEnvironment env;
...
void QSystemDispatcher::registerNatives()
{
#ifdef Q_OS_ANDROID
    QAndroidJniEnvironment env;
